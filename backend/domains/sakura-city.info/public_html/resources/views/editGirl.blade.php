...
@section('content')
    ...
    <br>
        ...
        <input type="checkbox" id="change" name="change"  onchange="document.getElementById(['country']).disabled = !this.checked;" > Изменить город
        <br>
        <label>Страна:
            <select style="width: 200px" class="country" class="form-control input-sm" name="country" id="country" disabled>
                <option value="-">-</option>
